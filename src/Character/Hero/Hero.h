...
public:
    Hero(const string& name, int health = 0, int strength = 0, int intelligence = 0, int defence = 0, int dexterity = 0)
    : BaseCharacter(name, health, strength, intelligence, defence, dexterity), gold(0), experience(0) {}
